...
Exemplo 2 — Filtrar candidaturas Enviadas
SELECT * FROM vw_candidaturas_filtradas WHERE status = 'Enviada';
...
Exemplo 4 — Filtrar candidaturas Enviadas criadas em 2025
SELECT * FROM vw_candidaturas_filtradas WHERE status = 'Enviada' AND YEAR(data_criacao) = 2025;

--- SQLite não suporta stored procedures. Foi convertido para consulta parametrizada, mas o uso continua similar.
...
Exemplo 2 — Candidaturas de um usuário com status "Enviada"
...
Buscar candidaturas com status Enviada,
